...
##### BUT : Ajouter ("CREATE") une donnée dans la "t_personne"
...
### Constater l'affichage du contenu de la table "t_personne"
...
* On réalise UNIQUEMENT (choix de OM de la 707) l'action READ du CRUD (Create Read Update Delete) sur la table "t_personne".
